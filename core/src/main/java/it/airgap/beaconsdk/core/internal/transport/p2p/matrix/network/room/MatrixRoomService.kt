package it.airgap.beaconsdk.core.internal.transport.p2p.matrix.network.room
...
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.room.*
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.network.MatrixService
import kotlinx.coroutines.flow.single

public class MatrixRoomService(httpClient: HttpClient) : MatrixService(httpClient) {
