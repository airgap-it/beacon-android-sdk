...
@Serializable
data class MatrixCreateRoomRequest(
    ...
    @Serializable
    enum class Preset {
        @SerialName("private_chat") PrivateChat,
        @SerialName("public_chat") PublicChat,
        @SerialName("trusted_private_chat") TrustedPrivateChat,
    }
}
