...
internal class P2pStoreTest {
    ...
    fun setup() {
        ...
        coEvery { migration.migrateMatrixRelayServer(any()) } returns Result.success()
    ...
    fun `initializes state with first active node`() {
        ...
        p2pStore = P2pStore(app, p2pProtocol, matrixClient, listOf(downNode, upNode), storageManager, migration)
