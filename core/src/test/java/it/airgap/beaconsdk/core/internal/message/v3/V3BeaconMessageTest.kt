...
internal class V3BeaconMessageTest {
    ...
    private fun messagesWithJsonStrings() =
        listOf(
            ...
            createErrorJsonPair(),
            createErrorJsonPair(blockchainIdentifier = null),
    ...
    private fun createErrorJsonPair(
        ...
        V3BeaconMessage(
            ...
            version,
            senderId,
            ErrorV3BeaconResponseContent(errorType, description, blockchainIdentifier),
        ) to """
            {
                "id": "$id",
                "version": "$version",
    ...
    private fun createPermissionResponsePair(
        ...
        ) to PermissionMockResponse("permission_response", id, version, origin, blockchainIdentifier, accountId, rest)
    }
    ...
    private fun createErrorResponsePair(
        ...
        ) to ErrorBeaconResponse(id, version, origin, errorType, description, blockchainIdentifier)
