package it.airgap.beaconsdk.core.internal.transport.p2p.matrix
...
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.MatrixSync
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.event.MatrixEventResponse
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.login.MatrixLoginResponse
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.room.MatrixCreateRoomRequest
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.room.MatrixCreateRoomRequest.Preset
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.room.MatrixCreateRoomResponse
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.room.MatrixInviteRoomResponse
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.room.MatrixJoinRoomResponse
...
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.data.api.sync.MatrixSyncState
...
import it.airgap.beaconsdk.core.internal.transport.p2p.matrix.store.*
