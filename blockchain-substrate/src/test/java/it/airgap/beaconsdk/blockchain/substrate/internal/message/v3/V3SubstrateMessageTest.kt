...
internal class V3SubstrateMessageTest {
    ...
    private fun createTransferRequestPair(
        ...
        V3BeaconMessage(
            ...
            network,
            when (mode) {
                TransferV3SubstrateRequest.Mode.Broadcast -> TransferSubstrateRequest.Mode.Broadcast
                TransferV3SubstrateRequest.Mode.BroadcastAndReturn -> TransferSubstrateRequest.Mode.BroadcastAndReturn
                TransferV3SubstrateRequest.Mode.Return -> TransferSubstrateRequest.Mode.Return
            },
        )
    ...
    private fun createSignRequestPair(
        ...
        V3BeaconMessage(
            ...
            payload,
            when (mode) {
                SignV3SubstrateRequest.Mode.Broadcast -> SignSubstrateRequest.Mode.Broadcast
                SignV3SubstrateRequest.Mode.BroadcastAndReturn -> SignSubstrateRequest.Mode.BroadcastAndReturn
                SignV3SubstrateRequest.Mode.Return -> SignSubstrateRequest.Mode.Return
            },
        )
    ...
    private fun createPermissionResponsePair(
        ...
        ) to PermissionSubstrateResponse(id, version, origin, Substrate.IDENTIFIER, accountId, appMetadata, scopes, accounts)
