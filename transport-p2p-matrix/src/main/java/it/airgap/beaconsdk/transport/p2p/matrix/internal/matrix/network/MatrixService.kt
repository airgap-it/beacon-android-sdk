...
public abstract class MatrixService(protected val httpClient: HttpClient) {
    ...
    protected fun apiUrl(node: String): String = "https://$node/${BeaconP2pMatrixConfiguration.MATRIX_API_BASE.trimStart('/')}"
}