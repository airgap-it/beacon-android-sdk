...
import it.airgap.client.dapp.internal.storage.plugin.ExtendedDAppClientStoragePlugin

public interface ExtendedDAppClientStorage : ExtendedStorage, ExtendedDAppClientStoragePlugin {
